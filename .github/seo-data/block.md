...
- Latest evidence: direct enumeration of the exact configured Drive folder on `2026-09-03` still finds **no** artifact family for the completed `2026-08-17_to_2026-08-23` window. The latest family remains `2026-08-24_to_2026-08-30`, generated on 31 August around 09:05 PDT, the morning after that window ended. No post-lag refresh/backfill appeared by 3 September; its Search Console date file still contains rows only through 29 August and omits 30 August.
