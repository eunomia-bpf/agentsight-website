...
- Latest evidence: direct enumeration of the exact configured Drive folder on `2026-09-02` still finds **no** artifact family for the final `2026-08-17_to_2026-08-23` window. The latest family remains `2026-08-24_to_2026-08-30`, generated on 31 August around 09:05 PDT, the morning after that window ended. As of 2 September this newer window has reached the configured three-day finalization boundary, but no post-lag refresh/backfill is present; its Search Console date file still contains rows only through 29 August and omits 30 August.
