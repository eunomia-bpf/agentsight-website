...
- Latest evidence: direct enumeration of the exact configured Drive folder on `2026-09-01` still finds **no** artifact family for the now-final `2026-08-17_to_2026-08-23` window, and no file in the folder has a 1 September modification timestamp. The newer `2026-08-24_to_2026-08-30` GA4/GSC family remains the latest artifact set; it was generated on 31 August around 09:05 PDT, only the morning after that window ended and therefore still inside the three-day lag. Its Search Console date file has rows through 29 August but no 30 August row. Earlier 3–9 and 10–16 August families were likewise generated the next morning; the inspected 10–16 GSC date file omitted 16 August.
- Impact: the exported rows are real source-native directional snapshots, but they cannot be treated as finalized weekly GA4/GSC evidence under the site's operating contract. The exporter has skipped a finalized window while continuing to emit newer pre-lag snapshots, so current finalized week-over-week analysis remains blocked.
