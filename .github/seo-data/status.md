...
- A representative unaffected route, `/blog/how-agentsight-discovers-local-agent-sessions/`, remained publicly retrievable. Exact-title search had not yet surfaced the new route immediately after publication; direct retrieval later succeeded, so this is index freshness rather than a deployment incident.
